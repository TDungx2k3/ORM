...
model customers {
  ...
  employees              employees? @relation(fields: [salesRepEmployeeNumber], references: [employeeNumber], onDelete: Restrict, onUpdate: Restrict, map: "customers_ibfk_1")
  orders                 orders[]
  payments               payments[]
...
model employees {
  ...
  customers       customers[]
  employees       employees?  @relation("employeesToemployees", fields: [reportsTo], references: [employeeNumber], onDelete: Restrict, onUpdate: Restrict, map: "employees_ibfk_1")
  other_employees employees[] @relation("employeesToemployees")
  offices         offices     @relation(fields: [officeCode], references: [officeCode], onUpdate: Restrict, map: "employees_ibfk_2")
...
model orderdetails {
  ...
  orders          orders   @relation(fields: [orderNumber], references: [orderNumber], onUpdate: Restrict, map: "orderdetails_ibfk_1")
  products        products @relation(fields: [productCode], references: [productCode], onUpdate: Restrict, map: "orderdetails_ibfk_2")
...
model orders {
  ...
  customers      customers      @relation(fields: [customerNumber], references: [customerNumber], onUpdate: Restrict, map: "orders_ibfk_1")
...
model payments {
  ...
  customers      customers @relation(fields: [customerNumber], references: [customerNumber], onUpdate: Restrict, map: "payments_ibfk_1")
...
model products {
  ...
  orderdetails       orderdetails[]
  productlines       productlines   @relation(fields: [productLine], references: [productLine], map: "products_ibfk_1")
